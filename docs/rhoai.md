...
2) Go to the `Data Science Projects` section and access your application's project named `demo-remote-cluster`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `demo-remote-cluster-notebook`.
...
5) In the terminal, run `cd demo-remote-cluster` to navigate to your sample app's directory.
