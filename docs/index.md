...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/demo-remote-cluster](https://github.com/rhdh-JslYoon-org/demo-remote-cluster)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/demo-remote-cluster-gitops](https://github.com/rhdh-JslYoon-org/demo-remote-cluster-gitops)

# **Usage**

To access the demo-remote-cluster application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of demo-remote-cluster. You can access this namespace through the web console or via your CLI.
